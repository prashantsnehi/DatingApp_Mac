...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        private readonly IHubContext<PresenceHub> _preseceHub;
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            else
            {
                ...
                if (connections != null)
                {
                    await _preseceHub.Clients.Clients(connections).SendAsync("NewMessageReceived", new
